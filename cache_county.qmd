...
Since 2025 still has a couple of months it's numbers haven't been included here, but the number of program participants has already surpassed 5,000, the number of new accounts is already above 2024's by over 120, and the number of Libby users continues to rise.
...
Use of all services is up from last year, aside from slight dips in visits and computer sessions. Libby use in particular has seen a significant increase. 
...
While visits were down in 2024, there were still more than 21,500 people who came to the Cache County Library physically. Digital material use - e.g., Libby - has increased which may mean that some people are using library services remotely rather than coming in person. The number of patron accounts has steadily increased across the years, and patrons are also coming in to use the computers at the library.
...
Circulation of library materials has remained steady for several years, with Libby checkouts increasing year-to-year.
...
Program participation has remained steady for the past several years, with over 2,000 people benefiting from library programs. Since 2025 still has a few months it hasn't been included here, but the number of program participants has already passed 5,000.
