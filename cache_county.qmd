...
While visits were down in 2024, there were still more than 21,500 people who came to the Cache County Library physically. Digital material use - e.g., Libby - has increased which may mean that some people are using library services remotely rather than coming in person. 
...
highchart() %>%
  ...
  hc_title(text = "Visits Over Time") %>%
  hc_plotOptions(series = list(marker = list(enabled = TRUE)))
```
...
Program participation has remained steady for the past several years, with over 2,000 people benefiting from library programs.
